...
def split_X_y(df, cat_cols, num_cols, ohe_cols, target, ):
...
def split_train_test(X,y, train_test_ratio, SEED, ):
    X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=train_test_ratio, random_state=SEED)
